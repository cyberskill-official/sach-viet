...
**Keep SMTP.** **Zalo OA still deferred** — no OA id invented. Accepted: `zalo: deferred until OA id provided by operator`.
...
| Support   | CyberSkill operator (interim)  | 2026-08-21 | interim-owner-defaults-2026-08-21b   |
| Privacy   | Align `DEC-PRIV-001`          | 2026-08-21 | interim-owner-defaults-2026-08-21b   |
...
| Zalo OA policy          | **`zalo: deferred until OA id provided by operator`.** No OA id. No Zalo channel activation. | Do not invent OA id. |
...
**Marketing:** off.  
**Zalo OA:** **`zalo: deferred until OA id provided by operator`** — **no OA id**.  
...
- **2026-08-21b:** Accepted wording: `zalo: deferred until OA id provided by operator`.
