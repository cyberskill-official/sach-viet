...
| `ADMIN_EMAIL_SYNC` | Set to `1` to rename the sole admin row to `ADMIN_EMAIL` on login (revokes sessions). Sign in with the **new** email after redeploy. Unset after successful login. |
