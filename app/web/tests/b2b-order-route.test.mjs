...
test("B2B order routes use signed sessions and server-side domain operations", async () => {
  ...
  for (const source of [staffOrders, staffOrder, institutionOrders, institutionOrder]) assert.match(source, /requireApiPermission/);
