...
test("cart normalization rejects malformed, duplicate, and out-of-range browser values", async () => {
...
test("cart transitions merge offers and keep quantity within checkout bounds", async () => {
...
test("notification merge is stable, newest-first, and deduplicated", async () => {
...
test("money formatting refuses non-numeric values", async () => {
