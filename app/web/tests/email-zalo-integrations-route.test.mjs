...
test("admin integrations status route uses signed sessions and non-secret status helper", () => {
...
test("notification preference route still updates user preferences under signed sessions", () => {
